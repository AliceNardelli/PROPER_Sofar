...
if __name__ == '__main__':
    ...
    ap.add_argument("-d", "--dir",  type=str, help="Path to folder containing checkerboard images for calibration", default="/home/alice/images/pepper_c/")
    ...
    ap.add_argument("-s", "--square_size", type=float, help="Length of one edge (in metres)", default=0.024)
    ...
    np.save("/home/alice/catkin_ws/src/PROPER_Sofar/ArUCo-Markers/pepper2_calibration_matrix.npy", mtx)
    np.save("/home/alice/catkin_ws/src/PROPER_Sofar/ArUCo-Markers/pepper2_distortion_coefficients.npy", dist)
    print("done")
