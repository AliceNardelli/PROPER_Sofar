...
unsc_actions=["distract_the_user_asking_a_random_question","make_a_thoughtless_consideration","say_that_sometimes_it_is_important_to_take_off_your_head", "say_that_it_is_nice_to_find_someone_with_its_head_in_the_clouds"]
