...
(:action NOT_ANSWER
        ...
        :effect
                (and
                           ...
                           (when (intro) (decrease (interaction_level)(*(extroversion_coefficient)(-(dur)1))))
                           (when (extro) (decrease (interaction_level)(*(extroversion_coefficient)(+(dur)10))))
                           (decrease (scrupulousness_level)(*(conscientious_coefficient)(dur)))
                           (when (agree) (decrease (agreeableness_level)(*(agreeableness_coefficient)(+(dur)10))))
                           (when (disagree) (decrease (agreeableness_level)(*(agreeableness_coefficient)(-(dur)1))))
                           (answered) 
                           (finished_sentence) 
                           (not (new_sentence))               
                )
...
(:action ANSWER
        ...
        :effect
                (and
                           ...
                           (when (intro) (decrease (interaction_level)(*(extroversion_coefficient)(-(dur)1))))
                           (when (extro) (decrease (interaction_level)(*(extroversion_coefficient)(+(dur)6))))
                           (when (consc) (decrease (scrupulousness_level)(*(conscientious_coefficient)(-(dur)1))))
                           (when (unsc) (decrease (scrupulousness_level)(*(conscientious_coefficient)(+(dur)4))))
                           (when (agree) (decrease (agreeableness_level)(*(agreeableness_coefficient)(-(dur)1))))
...
(:action ANSWER_WRONGLY
        ...
        :effect
                (and
                           ...
                           (decrease (interaction_level)(*(extroversion_coefficient)(+(dur)6)))
                           (when (unsc) (decrease (scrupulousness_level)(*(conscientious_coefficient)(-(dur)1))))
                           (when (consc) (decrease (scrupulousness_level)(*(conscientious_coefficient)(+(dur)10))))
                           (decrease (agreeableness_level)(*(agreeableness_coefficient)(+(dur)6)))
                           (answered) 
                           (not (new_sentence))                  
                )
)
...
(:action ANSWER_WITH_A_QUESTION
        ...
        :effect
                (and
                           ...
                           (when (intro) (decrease (interaction_level)(*(extroversion_coefficient)(+(dur)10))))
                           (when (extro) (decrease (interaction_level)(*(extroversion_coefficient)(-(dur)1))))
