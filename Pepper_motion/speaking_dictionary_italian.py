sentence_generation={
    "express_excitement":"Sono così eccitato di lavorare insieme",
    "express_enthusiasm_for_the_last_achieved_action":"Stiamo facendo davvero un bel lavoro!",
    "express_enthusiasm_for_the_next_future_work":"Se continuiamo così costruiremo davvero una bella torre",
    "chat":"behavior1",
    ...
    "chat_unsc":"behavior1",
    "say_no_matter_about_the_task":"Non preoccuparti se fai degli errori, può succedere",
    "ask_if_human_need_help":"Hai bisogno di aiuto?",
    "say_that_you_know_it_is_a_difficult_task":"Mi dispiace se stai faticando",
    "say_to_not_matter_if_an_error_occur":"Non proccuparti se fai degli errori, può succedere",
    "say_you_are_sorry_for_the_fatigue":"Sono molto dispiaciuto se ti sto facendo stancare",
    "say_the_human_he_is_doing_a_good_work":"Stai lavorando davvero molto bene, continua così",
    ...
    "say_the_human_should_work_better":"Potresti lavorare meglio e più velocemente",
...
behavior2=["Ciao, il mio nome è Pepper","Finalmente sei arrivato ad aiutarmi","Ti ho chiamato perchè devo costruire una torre di cubetti e da solo non ci riesco","Ora ti spegherò cosa ovrai fare","Ogni volta che ti porterò un cubetto dovrai prenderlo","Dovrai poi assemblarlo per costruire la torre","è ora di iniziare lavorare!"]
behavior3=["Ciao, il mio nome è Pepper","Finalmente sei arrivato ad aiutarmi","Ti ho chiamato perchè devo costruire una torre di cubetti e da solo non ci riesco","Ora ti spegherò cosa ovrai fare","Ogni volta che te lo chiederò dovrai passarmi un blocchetto di un colore specifico","Il colore te lo dirò io", "è ora di iniziare lavorare!"]
...
behavior10=["Abbiamo finito di costruire la torre", "Il tuo aiuto è stato fondamentale", "La nostra collaborazione ha avuto successo", "La prossima volta che avrò bisogno dinuovo te lo chiederò","Arrivederci e a presto"]
